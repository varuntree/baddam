...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-[80%] max-w-3xl z-50 bg-black/10 backdrop-blur-lg px-6 md:px-8 lg:px-12 rounded-3xl mx-auto left-0 right-0 mt-4"> {/* Added padding here */}
      ...
      {/* Mobile menu */}
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden bg-black/30 backdrop-blur-md px-6 md:px-8 lg:px-12 rounded-b-3xl`}> {/* Added padding here */}

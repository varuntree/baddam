      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative text-center mb-16 p-8 backdrop-blur-sm bg-white/5 rounded-3xl border border-white/10 mx-auto max-w-3xl">
          ...
          <h2 className="text-4xl md:text-5xl font-medium mb-4">
            Are you ready to be{" "}
            <span className="text-primary">turbocharged</span>?
          </h2>
          <p className="text-gray-400 mb-8">
            Fill in your details and we'll connect.
          </p>
          <Link
            href="/contact"
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div>
            <h3 className="font-medium mb-4 text-gray-300">
              PROGRAMS & COURSES
            </h3>

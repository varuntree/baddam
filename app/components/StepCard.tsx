...
export default function StepCard({ stepNumber, title, description }: StepCardProps) {
  return (
    <div className="flex flex-col md:flex-row gap-8 h-full items-center p-8 rounded-3xl bg-white/5 backdrop-blur-lg border border-white/10 transition-all duration-500">

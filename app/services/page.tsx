          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative h-[400px] p-6 flex flex-col justify-end">
                <p className={`mb-2 transition-colors duration-300 ${hoveredCardIndex === index ? 'text-white/80' : 'text-black/60'}`}>0{index + 1}</p>
                ...
                <p className={`transition-colors duration-300 ${hoveredCardIndex === index ? 'text-white' : 'text-black/80'}`}>{service.description}</p>
              </div>
            </div>
          ))}
        </div>

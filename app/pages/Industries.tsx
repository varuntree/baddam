...
export default function Industries() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Main Content */}
      <div className="relative h-full min-h-screen flex flex-col md:flex-row">
        {/* Side Card - Full width on mobile, side on desktop */}
        <div className="w-full md:w-1/3 lg:w-1/4 bg-white/10 backdrop-blur-lg md:backdrop-blur-2xl border-b md:border-r border-white/20">
          <div className="p-6">
        ...
        {/* Glassmorphic Card - Hidden on mobile */}
        <div className="hidden md:flex flex-1 items-center justify-center p-8">
          <div className="w-80 h-96 bg-black/10 backdrop-blur-2xl rounded-3xl border border-white/20 p-8 flex flex-col items-center justify-between">
